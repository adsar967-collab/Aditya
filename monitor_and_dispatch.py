...
# LIST YOUR COMPETITORS HERE (Replace with real usernames in your niche)
...
def fetch_competitor_data():
    ...
    # Using Apify's popular, free-tier friendly Instagram Scraper Actor
    url = f"https://api.apify.com/v2/acts/apify~instagram-scraper/run-sync-get-dataset-items?token={apify_token}"
    
    # Configure what we want Apify to scrape
    payload = {
